...
<context>
    ...
    <message id="jolla-email-la-download-attachments-header" numerus="yes">
        ...
        <numerusform>تنزيل مرفق واحد؟</numerusform>
    ...
    <message id="jolla-email-la-forward-attachments-info" numerus="yes">
        ...
        <translation><numerusform>مرفق البريد الذي سيتم توجيهه لم يتم تحميله</numerusform>
    ...
    <message id="jolla-email-la-attachments-download-failed-info" numerus="yes">
        ...
        <translation><numerusform>تعذر تنزيل المرفق. تحقق من سلامة اتصالك بالإنترنت.</numerusform>
    ...
    <message id="jolla-email-he-attachments_page" numerus="yes">
        ...
        <translation><numerusform>%n مرفق</numerusform>
        <numerusform>مرفق واحد</numerusform>
        <numerusform>مرفقان</numerusform>
    ...
    <message id="jolla-email-me-add_account">
        ...
        <location filename="../pages/NoAccountsPage.qml" line="21"></location>
    ...
    <message id="jolla-email-la-priority_Normal">
        ...
        <location filename="../pages/MessageInfo.qml" line="152"></location>
...
Message priority normal</extracomment>
    ...
    <message id="jolla-email-la-priority_high">
        ...
        <location filename="../pages/MessageInfo.qml" line="144"></location>
        <source>High</source>
...
Message priority high</extracomment>
    ...
    <message id="jolla-email-la-priority_low">
        ...
        <location filename="../pages/MessageInfo.qml" line="148"></location>
        <source>Low</source>
...
Message priority low</extracomment>
    ...
    <message id="jolla-components_email-la-attachments_summary" numerus="yes">
        ...
        <translation><numerusform>%n آخر</numerusform>
        <numerusform>%n آخر</numerusform>
        <numerusform>%n آخرون</numerusform>
        <numerusform>%n آخرون</numerusform>
        <numerusform>%n آخرون</numerusform>
        <numerusform>%n آخرون</numerusform>
        </translation></message>
    <message id="jolla-components_email-la-attachments" numerus="yes">
    ...
    <message id="email-la_no_accounts">
        <location filename="../components/NoAccountsPlaceholder.qml" line="15"></location>
    ...
    <message id="email-la_no_accounts_hint_text">
        <location filename="../components/NoAccountsPlaceholder.qml" line="19"></location>
    ...
    <message id="email-la-accounts_creation_disabled_by_device_manager">
        <location filename="../components/NoAccountsPlaceholder.qml" line="22"></location>
        ...
        <translation>تم تعطيل إنشاء الحساب من قبل مدير الجهاز %1</translation>
    </message>
    ...
    <message id="jolla-email-la-unread-emails" numerus="yes">
        ...
        <translation><numerusform>رسالة&lt;br/&gt;غير مقروءة</numerusform>
        <numerusform>رسالة&lt;br/&gt;غير مقروءة</numerusform>
        <numerusform>رسالتان&lt;br/&gt;غير مقروءة</numerusform>
    ...
    <message id="email-la_up_to_date">
        <location filename="../email.qml" line="36"></location>
    ...
    <message id="jolla-email-la-response_failed_body_accept">
        <location filename="../email.qml" line="249"></location>
    ...
    <message id="jolla-email-la-response_failed_body_tentative">
        <location filename="../email.qml" line="254"></location>
    ...
    <message id="jolla-email-la-response_failed_body_decline">
        <location filename="../email.qml" line="259"></location>
    ...
    <message id="jolla-email-me-sync">
        ...
        <location filename="../pages/MessageListView.qml" line="253"></location>
        <source>Sync</source>
...
Synchronise account menu item</extracomment>
    ...
    <message id="jolla-email-la-attachments_summary" numerus="yes">
        <location filename="../pages/AttachmentRow.qml" line="72"></location>
        <source>%n attachments</source>
    ...
    <message id="jolla-email-la-calendar_invitation">
        <location filename="../pages/CalendarDelegate.qml" line="87"></location>
    ...
    <message id="jolla-email-la-calendar_invitation_not_downloaded">
        <location filename="../pages/CalendarDelegate.qml" line="117"></location>
    ...
    <message id="jolla-email-la-calendar_invitation_downloaded">
        <location filename="../pages/CalendarDelegate.qml" line="121"></location>
    ...
    <message id="jolla-email-la-calendar_invitation_downloading">
        <location filename="../pages/CalendarDelegate.qml" line="125"></location>
    ...
    <message id="jolla-email-la-calendar_invitation_failed">
        <location filename="../pages/CalendarDelegate.qml" line="129"></location>
    ...
    <message id="jolla-email-la-calendar_invitation_failed_save">
        <location filename="../pages/CalendarDelegate.qml" line="133"></location>
    ...
    <message id="jolla-email-me-deleting-mail">
        <location filename="../pages/CombinedInbox.qml" line="40"></location>
        <source>Deleting mail</source>
        <translation>حذف رسالة البريد</translation>
    </message>
    <message id="jolla-email-me-select_messages">
        <location filename="../pages/CombinedInbox.qml" line="60"></location>
        <location filename="../pages/MessageListView.qml" line="226"></location>
        <source>Select messages</source>
        <translation>حدد رسائل البريد</translation>
    </message>
    <message id="jolla-email-me-sync_all">
        <location filename="../pages/CombinedInbox.qml" line="73"></location>
    ...
    <message id="jolla-email-me-new_message">
        <location filename="../pages/CombinedInbox.qml" line="82"></location>
        <location filename="../pages/MessageListView.qml" line="268"></location>
        <source>New Message</source>
        <extracomment>New message menu item</extracomment>
        <translation>رسالة بريد جديدة</translation>
    </message>
    <message id="email-he-email">
        <location filename="../pages/CombinedInbox.qml" line="95"></location>
        <location filename="../pages/NoAccountsPage.qml" line="31"></location>
        <source>Mail</source>
        <extracomment>Email page header</extracomment>
        <translation>البريد الإلكتروني</translation>
    </message>
    <message id="email-la_unread_messages_in_inboxes">
        <location filename="../pages/CombinedInbox.qml" line="108"></location>
    ...
    <message id="email-la_no_unread_messages_in_inboxes">
        <location filename="../pages/CombinedInbox.qml" line="134"></location>
    ...
    <message id="jolla-email-la-load_images">
        <location filename="../pages/LoadImagesItem.qml" line="34"></location>
    ...
    <message id="jolla-email-la-cal-when">
        <location filename="../pages/MessageInfo.qml" line="79"></location>
        <source>When:</source>
    ...
    <message id="jolla-email-la-cal-organizer">
        <location filename="../pages/MessageInfo.qml" line="91"></location>
    ...
    <message id="jolla-email-la-replyTo">
        <location filename="../pages/MessageInfo.qml" line="99"></location>
    ...
    <message id="jolla-email-la-cal-mandatory_info">
        <location filename="../pages/MessageInfo.qml" line="109"></location>
    ...
    <message id="jolla-email-la-to_info">
        <location filename="../pages/MessageInfo.qml" line="113"></location>
        <source>To:</source>
        <extracomment>'To: ' recipients label</extracomment>
        <translation>إلى:</translation>
    </message>
    <message id="jolla-email-la-cal-optional_info">
        <location filename="../pages/MessageInfo.qml" line="125"></location>
    ...
    <message id="jolla-email-la-cc_info">
        <location filename="../pages/MessageInfo.qml" line="129"></location>
        <source>Cc:</source>
        <extracomment>'Cc: ' recipients label</extracomment>
        <translation>نسخة:</translation>
    </message>
    <message id="jolla-email-la-importance">
        <location filename="../pages/MessageInfo.qml" line="138"></location>
        <source>Importance:</source>
        <extracomment>'Importance: ' label</extracomment>
        <translation>الأهمية:</translation>
    </message>
    <message id="jolla-email-la-cal-secrecy">
        <location filename="../pages/MessageInfo.qml" line="161"></location>
    ...
    <message id="jolla-email-la-cal-secrecy_private">
        <location filename="../pages/MessageInfo.qml" line="168"></location>
    ...
    <message id="jolla-email-la-cal-secrecy_confidential">
        <location filename="../pages/MessageInfo.qml" line="172"></location>
    ...
    <message id="jolla-email-la-cal-secrecy_public">
        <location filename="../pages/MessageInfo.qml" line="176"></location>
        <source>Public</source>
        <extracomment>Invitation secrecy public</extracomment>
        <translation>عام</translation>
    </message>
    <message id="jolla-email-la-cal-repeat">
        <location filename="../pages/MessageInfo.qml" line="185"></location>
    ...
    <message id="jolla-email-la-no_recipient">
        ...
        <location filename="../pages/MessageViewHeader.qml" line="49"></location>
    ...
    <message id="jolla-email-la-no_subject">
        ...
        <location filename="../pages/MessageListView.qml" line="318"></location>
    ...
    <message id="jolla-email-he-updating">
        <location filename="../pages/MessageListView.qml" line="83"></location>
        <source>Updating...</source>
        <extracomment>Updating header</extracomment>
        <translation>جار التحديث ...</translation>
    </message>
    <message id="jolla-email-la-small_size">
        <location filename="../pages/MessageListView.qml" line="122"></location>
    ...
    <message id="jolla-email-la-medium_size">
        <location filename="../pages/MessageListView.qml" line="126"></location>
    ...
    <message id="jolla-email-la-large_size">
        <location filename="../pages/MessageListView.qml" line="130"></location>
    ...
    <message id="jolla-email-la-read_email">
        <location filename="../pages/MessageListView.qml" line="136"></location>
    ...
    <message id="jolla-email-la-unread_email">
        <location filename="../pages/MessageListView.qml" line="140"></location>
    ...
    <message id="jolla-email-la-no_attachments">
        <location filename="../pages/MessageListView.qml" line="165"></location>
        <source>No attachments</source>
    ...
    <message id="jolla-email-me-send-all">
        <location filename="../pages/MessageListView.qml" line="250"></location>
    ...
    <message id="jolla-email-me-get_more_mails">
        <location filename="../pages/MessageListView.qml" line="281"></location>
        <source>Get more mails</source>
        <translation>جلب المزيد من رسائل البريد</translation>
    </message>
    <message id="jolla-email-la-empty_list">
        <location filename="../pages/MessageListView.qml" line="302"></location>
    ...
    <message id="jolla-email-me-deleted-mails" numerus="yes">
        ...
        <translation><numerusform>تم حذف %n رسالة بريد إلكتروني</numerusform>
        <numerusform>تم حذف رسالة بريد إلكتروني</numerusform>
        <numerusform>تم حذف رسالتان بريد إلكتروني</numerusform>
        <numerusform>تم حذف %n رسائل بريد إلكتروني</numerusform>
        <numerusform>تم حذف %n رسالة بريد إلكتروني</numerusform>
        <numerusform>تم حذف %n رسالة بريد إلكتروني</numerusform>
        </translation></message>
    <message id="jolla-email-la-read_receipt_email_subject_prefix">
        <location filename="../pages/MessageView.qml" line="63"></location>
    ...
    <message id="jolla-email-la-read_receipt_email_body">
        <location filename="../pages/MessageView.qml" line="65"></location>
    ...
    <message id="jolla-email-la-failed_send_read_receipt">
        <location filename="../pages/MessageView.qml" line="70"></location>
    ...
    <message id="jolla-email-la-reply">
        <location filename="../pages/MessageViewFooter.qml" line="56"></location>
        <source>Reply</source>
        <translation>الرد</translation>
    </message>
    <message id="jolla-email-la-reply_all">
        <location filename="../pages/MessageViewFooter.qml" line="66"></location>
        <source>Reply All</source>
        <translation>الرد على الكل</translation>
    </message>
    <message id="jolla-email-la-delete">
        <location filename="../pages/MessageViewFooter.qml" line="74"></location>
        <source>Delete</source>
        <translation>حذف</translation>
    </message>
    <message id="jolla-email-la-forward">
        <location filename="../pages/MessageViewFooter.qml" line="79"></location>
        <source>Forward</source>
        <translation>توجيه</translation>
    </message>
    <message id="jolla-email-la-recipients_header">
        <location filename="../pages/MessageViewHeader.qml" line="47"></location>
        <source>To: %1</source>
    ...
    <message id="jolla-email-he-select_messages" numerus="yes">
        <location filename="../pages/MultiSelectionPage.qml" line="62"></location>
        <source>Selected %n</source>
        <extracomment>Selected messages</extracomment>
        <translation><numerusform>تم إختيار %n</numerusform>
        <numerusform>تم إختيار واحد</numerusform>
        <numerusform>تم إختيار إثنان</numerusform>
        <numerusform>تم إختيار %n</numerusform>
        <numerusform>تم إختيار %n</numerusform>
        <numerusform>تم إختيار %n</numerusform>
        </translation></message>
    <message id="jolla-email-he-zero_selected_messages">
        <location filename="../pages/MultiSelectionPage.qml" line="65"></location>
    ...
    <message id="jolla-email-me-deselect_all_messages">
        <location filename="../pages/MultiSelectionPage.qml" line="102"></location>
    ...
    <message id="jolla-email-me-select_all_messages">
        <location filename="../pages/MultiSelectionPage.qml" line="110"></location>
    ...
    <message id="jolla-email-me-search_options">
        <location filename="../pages/SearchPage.qml" line="65"></location>
        <source>Search options</source>
        <translation>خيارات البحث</translation>
    </message>
    <message id="jolla-email-he-search">
        <location filename="../pages/SearchPage.qml" line="144"></location>
        <source>Search</source>
    ...
    <message id="jolla-email-la-sig-downloading">
        <location filename="../pages/SignatureItem.qml" line="59"></location>
    ...
    <message id="jolla-email-la-sig-missing">
        <location filename="../pages/SignatureItem.qml" line="62"></location>
    ...
    <message id="jolla-email-la-sig-checking">
        <location filename="../pages/SignatureItem.qml" line="65"></location>
    ...
    <message id="jolla-email-la-sig-valid">
        <location filename="../pages/SignatureItem.qml" line="68"></location>
    ...
    <message id="jolla-email-la-sig-invalid">
        <location filename="../pages/SignatureItem.qml" line="71"></location>
    ...
    <message id="jolla-email-la-sig-expired-download">
        <location filename="../pages/SignatureItem.qml" line="75"></location>
    ...
    <message id="jolla-email-la-sig-expired">
        <location filename="../pages/SignatureItem.qml" line="77"></location>
    ...
    <message id="jolla-email-la-sig-nokey-download">
        <location filename="../pages/SignatureItem.qml" line="81"></location>
    ...
    <message id="jolla-email-la-sig-nokey">
        <location filename="../pages/SignatureItem.qml" line="83"></location>
    ...
    <message id="jolla-email-la-sig-unchecked">
        <location filename="../pages/SignatureItem.qml" line="86"></location>
        <source>Check signature</source>
        <translation>تحقق من التوقيع</translation>
    </message>
    <message id="jolla-email-la-sig-failure">
        <location filename="../pages/SignatureItem.qml" line="89"></location>
    ...
    <message id="jolla-email-la-crypto_protocol_pgp">
        <location filename="../pages/SignatureItem.qml" line="107"></location>
    ...
    <message id="jolla-email-la-crypto_protocol_smime">
        <location filename="../pages/SignatureItem.qml" line="111"></location>
        <source>S/MIME - key %1</source>
        <extracomment>%1: identifier of the signing key, usually 8 hexadecimal characters</extracomment>
        <translation>S/MIME - key 1%</translation>
    </message>
    <message id="jolla-email-la-sig-retrieving">
        <location filename="../pages/SignatureItem.qml" line="130"></location>
